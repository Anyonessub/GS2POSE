...
class GaussianModel:
    def __init__(self, sh_degree: int, config=None):
        ...
        self.max_sh_degree = sh_degree # sh_degree
    ...
    def fetchPly(self, path):
        ...
        self.create_from_pcd(BasicPointCloud(points=positions, colors=colors, normals=normals))
    ...
    def training_setup(self, training_args):
        ...
        l = [
            ...
            # },
            {
                ...
                "lr": training_args.rotation_lr * 2,
                "name": "rotation",
            }
        ]
    ...
    def full_training_setup(self, training_args):
        self.percent_dense = training_args.percent_dense
        self.xyz_gradient_accum = torch.zeros((self.get_xyz.shape[0], 1), device="cuda")
        self.denom = torch.zeros((self.get_xyz.shape[0], 1), device="cuda")
