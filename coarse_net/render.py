...
class LMRender:
    ...
    def readCamerasFromSceneGt(self, path):
        ...
        for key, extr in cam_extr.items():
            ...
            cam_infos.append(Camera(torch.tensor(T_CW, dtype=torch.float32, device='cuda'), self.config, device=self.device))
        return cam_infos
...
if __name__ == "__main__":
    ...
    plypath = "refine/000015/point_cloud/iteration_2000/point_cloud.ply"
    scene_gt_path = "data/lm/test/000015/scene_gt.json"
    rende_path = "render_result/000015"
