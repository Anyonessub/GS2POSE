...
def func():
    ...
    # 训练集
    train_image_root = 'data/000009/train/gt'
    train_label_root = 'data/000009/train/render'
    train_set = GetLoader(train_image_root, train_label_root, transform=transform)

    #验证集
    val_image_root = 'data/000009/val/gt'
    val_label_root = 'data/000009/val/render'
    ...
    if resume == 1:
        checkpoint_path = './checkpoints/checkpoint-490_1.pth'
