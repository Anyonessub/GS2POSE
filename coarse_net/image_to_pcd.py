...
# 读取RGB图像和Depth图像
rgb_image_path = 'lmo_data/000001/result/000356.png'
depth_image_path = 'lmo_data/000001/depth_mask/000356.png'
...
if depth_image is not None:
    ...
    # 构造3D点云
    depth_image_3d = depth_image.astype(np.float32) / 1000.0  # 将深度图像转换为3D坐标
