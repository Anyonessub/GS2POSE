...
# 定义深度图像和掩码图像的文件夹路径
depth_folder = "data/lm/test/000014/depth/"
mask_folder = "data/lm/test/000014/mask/"
output_folder = "data/lm/test/000014/depth_mask"
...
for filename in depth_files:
    if filename.endswith(".png"):  # 确保处理的是PNG文件
        ...
        mask_filename = filename.replace(".png", "_000000.png")
